...
struct BasicBlock {
    ...
    BasicBlock(const bb_t& i, const std::vector<ident_t>& p1_ident_vals, 
                const std::vector<ident_t>& p2_ident_vals, const bb_t& p1, const bb_t& p2, int& instruction_count);    
